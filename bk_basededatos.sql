...
('Notificación de Documento Cargado', 'documento_cargado', '[Sistema] Nuevo documento subido por {{cliente}}', 'Se envía al administrador cuando un cliente sube un documento desde el portal.', 'cliente, dni, documento, fecha', 
...
('Documento Aprobado', 'documento_aprobado', '¡Excelente! Tu documento ha sido aprobado', 'Se envía al cliente cuando la administración aprueba un documento.', 'cliente, documento, portal_url', 
...
('Documento Rechazado', 'documento_rechazado', 'Atención: Tu documento ha sido rechazado', 'Se envía al cliente cuando la administración rechaza un documento indicando el motivo.', 'cliente, documento, motivo, portal_url', 
